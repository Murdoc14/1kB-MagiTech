...
mods.bloodmagic.Altar.addRecipe(<bloodmagic:ItemInscriptionTool:1>, 3, 1000, 5, 5, [<botania:rune>]);
mods.bloodmagic.Altar.removeRecipe(<bloodmagic:ItemInscriptionTool:2>);
mods.bloodmagic.Altar.addRecipe(<bloodmagic:ItemInscriptionTool:2>, 3, 1000, 5, 5, [<botania:rune:1>]);
mods.bloodmagic.Altar.removeRecipe(<bloodmagic:ItemInscriptionTool:3>);
mods.bloodmagic.Altar.addRecipe(<bloodmagic:ItemInscriptionTool:3>, 3, 1000, 5, 5, [<botania:rune:2>]);
mods.bloodmagic.Altar.removeRecipe(<bloodmagic:ItemInscriptionTool:4>);
mods.bloodmagic.Altar.addRecipe(<bloodmagic:ItemInscriptionTool:4>, 3, 1000, 5, 5, [<botania:rune:3>]);
mods.bloodmagic.Altar.removeRecipe(<bloodmagic:ItemInscriptionTool:5>);
mods.bloodmagic.Altar.addRecipe(<bloodmagic:ItemInscriptionTool:5>, 4, 2000, 20, 10, [<embers:ashenStone>]);
mods.bloodmagic.Altar.removeRecipe(<bloodmagic:ItemInscriptionTool:6>);
mods.bloodmagic.Altar.addRecipe(<bloodmagic:ItemInscriptionTool:6>, 6, 200000, 100, 200, [<embers:aspectusDawnstone>]);
