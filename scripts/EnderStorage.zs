...
recipes.addShaped(<enderstorage:enderStorage:1>, [[<ore:rodBlaze>, <minecraft:wool>, <ore:rodBlaze>], [<ore:obsidian>, <extrautils2:klein>, <ore:obsidian>], [<ore:rodBlaze>, <minecraft:cauldron>, <ore:rodBlaze>]]);

recipes.remove(<enderstorage:enderStorage>);
recipes.addShaped(<enderstorage:enderStorage>, [[<ore:rodBlaze>, <ore:blockWool>, <ore:rodBlaze>], [<railcraft:generic:7>, <ore:chest>, <railcraft:generic:7>], [<ore:rodBlaze>, <railcraft:generic:7>, <ore:rodBlaze>]]);
