...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_overclock"}), [[<ore:blockCobalt>, <ore:blockArdite>, <ore:blockCobalt>], [<ore:ingotCobalt>, <ic2:resource:13>, <ore:ingotCobalt>], [<ore:gearEnderium>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <substratum:gear:18>]]);
...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_culinary"}), [[<harvestcraft:firmtofuItem>, <harvestcraft:firmtofuItem>, <harvestcraft:firmtofuItem>], [<harvestcraft:firmtofuItem>, <harvestcraft:presser>, <harvestcraft:firmtofuItem>], [<ore:gearLead>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_overclock"}), <substratum:gear:13>]]);
...
recipes.addShaped(<extrautils2:klein>, [[null, <substratum:bottleLiquid:2>, null], [<substratum:bottleLiquid:2>, <bloodmagic:ItemPotionFlask>, <substratum:bottleLiquid:2>], [null, <substratum:bottleLiquid:2>, null]]);
