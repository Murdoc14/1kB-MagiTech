...
mods.forestry.Carpenter.addRecipe(<iskalliumreactors:steel_casing> * 2, [[<ic2:plating>, <ic2:plating>, <ic2:plating>], [<ic2:plating>, <iskalliumreactors:iskallium_essence>, <ic2:plating>], [<ic2:plating>, <ic2:plating>, <ic2:plating>]], 4800, <liquid:creosote> * 10000);
recipes.remove(<iskalliumreactors:steel_ingot>);


recipes.remove(<iskalliumreactors:iskallium_glass> * 8);
mods.forestry.ThermionicFabricator.addCast(<iskalliumreactors:iskallium_glass>, [[<thermalfoundation:glass_alloy:7>, <thermalfoundation:glass_alloy:7>, <thermalfoundation:glass_alloy:7>], [<thermalfoundation:glass_alloy:7>, <iskalliumreactors:iskallium_essence>, <thermalfoundation:glass_alloy:7>], [<thermalfoundation:glass_alloy:7>, <thermalfoundation:glass_alloy:7>, <thermalfoundation:glass_alloy:7>]],8000);
