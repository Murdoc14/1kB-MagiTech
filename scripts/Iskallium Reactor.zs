...
mods.forestry.ThermionicFabricator.addCast(<fluxnetworks:GargantuanFluxStorage>, [[<thermalfoundation:glass_alloy:7>, <thermalfoundation:glass_alloy:7>, <thermalfoundation:glass_alloy:7>], [<thermalfoundation:glass_alloy:7>, <iskalliumreactors:iskallium_essence>, <thermalfoundation:glass_alloy:7>], [<thermalfoundation:glass_alloy:7>, <thermalfoundation:glass_alloy:7>, <thermalfoundation:glass_alloy:7>]],10000);
